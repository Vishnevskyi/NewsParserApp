...
const Article = (props) => {
    ...
    if (news.length === 0) {
        ...
        return (
            ...
            {news.image.includes("http") ? <img style={{borderRadius: "3em"}} className={classes.image} src={news.image} alt={news.title} />: <img className={classes.image} src={`/img/${news.image}`} alt={news.title} />}
            <br/>
